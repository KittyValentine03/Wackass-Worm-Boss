...
namespace Zephira.Content.NPCs
{
    ...
    public abstract class WormHead : Worm
    {
        ...
        /// <summary>
        /// The maximum distance in <b>pixels</b> within which the NPC will use tile collision, if <see cref="CanFly"/> returns <see langword="true"/>.<br/>
